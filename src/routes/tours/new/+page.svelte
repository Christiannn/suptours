...
<svelte:head>
	<title>Create a SUP Tour — SUP Tours</title>
</svelte:head>

<div class="wizard">
	<header class="wizard__header">
		<h1 class="wizard__title">Create Your Tour</h1>
	...
	<form method="POST" action="?/create" use:enhance class="wizard__form">
		<!-- Hidden fields for all data (always present for final submit) -->
		...
		{#if step === 1}
			<div class="wizard__panel">
				...
				<label class="wizard__label" for="image_url">Image URL (optional)</label>
				<input
					id="image_url"
					type="url"
					bind:value={imageUrl}
		...
		<div class="wizard__nav">
			...
			{:else}
				<div class="wizard__submit-group">
					<button type="submit" name="action" value="draft" class="wizard__btn wizard__btn--draft">
						Save Draft
					</button>
					<button type="submit" name="action" value="publish" class="wizard__btn wizard__btn--publish">
