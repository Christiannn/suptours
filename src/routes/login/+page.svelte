...
<div class="auth-page">
	<div class="auth-card">
		...
		<p class="auth-subtitle">Log in to find and join SUP tours</p>

		<!-- OAuth buttons -->
		<div class="oauth-buttons">
			<form method="POST" action="?/google" use:enhance>
				<button type="submit" class="oauth-btn oauth-btn--google">
			...
			<form method="POST" action="?/facebook" use:enhance>
				<button type="submit" class="oauth-btn oauth-btn--facebook">
					<svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
